...
[PR #171](https://github.com/markcuda/omarchy-kids-sandbox/pull/171), for hidden weekend time limits, passed the test-box formatter, the 42-file Mac suite with five skips, the same VM suite with two skips, and scenario05. Its installed candidate passed default/custom weekend values and Back-to-Time acceptance in both fresh watched themes, independent screenshot review, and separate restoration readback. All 181 package files remain intact; original settings/themes/timer/greeter are restored and Ben is absent. [Sixteen exact screenshots](media/dogfood/wizard170-598a82f/README.md) document the candidate; 81 originals are retained. It remains unmerged at this checkpoint. A separate [blank Advanced editor finding](media/dogfood/wizard-current-input-598a82f/README.md) has reviewed screenshot evidence and awaits its ticket. New [#172](https://github.com/markcuda/omarchy-kids-sandbox/issues/172) records the Advanced app list clipping in both themes; reviewed draft [PR #173](https://github.com/markcuda/omarchy-kids-sandbox/pull/173) exposes the full list in the card and remains stacked behind #171. Its full gates and live rendering are pending. Reviewed [draft PR #175](https://github.com/markcuda/omarchy-kids-sandbox/pull/175) keeps desktop choices in plain words across the wizard; it is stacked behind #173 and awaits full gates/live proof. The #98/#109 human decision, #97 ordering hold, and three full release walkthroughs remain open.
