...
![Latte: all eight app labels and the full checklist fit.](w172-latte-eight-08-advanced-default.png)

## Latte: the settled sixteen-app rendering fits, including Done.

![Latte: the settled sixteen-app rendering fits, including Done.](w172-latte-sixteen-10-advanced-settled.png)

## Tokyo: all eight app labels and the full checklist fit.

![Tokyo: all eight app labels and the full checklist fit.](w172-tokyo-eight-08-advanced-default.png)

## Tokyo: all sixteen app labels and the full checklist fit.

![Tokyo: all sixteen app labels and the full checklist fit.](w172-tokyo-sixteen-12-advanced-default.png)

## Latte editing failure: no app prompt appeared; selection became empty. The original filename is retained.

![Latte editing failure: no app prompt appeared; selection became empty. The original filename is retained.](w172-latte-eight-10-gcompris.png)

## Tokyo editing failure: opening Starter apps again produced an empty selection.

![Tokyo editing failure: opening Starter apps again produced an empty selection.](w172-tokyo-eight-10-picker-result.png)
