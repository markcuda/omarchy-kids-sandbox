...
screen_level() {
  ...
  local choices=(
    "1|$(friendly_desktop_level 1)|Simplest — one app fills the screen."
    "2|$(friendly_desktop_level 2)|Split-screen multitasking."
    "3|$(friendly_desktop_level 3)|Everything Omarchy normally offers."
  )
...
screen_summary() {
  while true; do
    ...
    local rows=(
      ...
      "Desktop|$(mark_if_changed level "$(friendly_desktop_level "$LEVEL")")"
