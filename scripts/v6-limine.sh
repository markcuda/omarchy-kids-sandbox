...
for i in $(seq 1 10); do
  qmp key down >/dev/null 2>&1
  sleep 0.4
done
qmp key up
sleep 1
shot v6-menu
echo "== editor on the default entry =="
qmp key e
sleep 2
shot v6-editor-default
qmp key esc
sleep 1
echo "== expand and inspect the last entry (snapshots live at the bottom) =="
for i in 1 2 3 4 5 6; do qmp key down; done
sleep 1
shot v6-menu-bottom
qmp key ret
sleep 1
shot v6-menu-bottom-open
qmp key e
sleep 2
shot v6-editor-bottom
qmp key esc
sleep 1
echo "== boot the default entry =="
for i in 1 2 3 4 5 6 7 8; do qmp key up; done
qmp enter
sleep 45
qmp type "$PW"
qmp enter
